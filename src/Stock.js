...
class Stock extends React.Component{
    ...
    incrementCounter(){
       ...
       // let currentCounter = this.state.counterSelector;
    ...
    removeWatch = (i) => {
        ...
        // this.decrementWatchCounter(this.state.watchSelector);
            ...
            <div className="form_active_list">
                <div className="form_block_stock w-form">
                    <div id="email-form" name="email-form" data-name="Email Form" className="form_stock">
                        {/*<div onClick = {this.addStock} type="text" className="text_field_stock w-input" maxlength="256" name="Add-stock"*/}
                               {/*data-name="Add stock" placeholder="Add stock" id="Add-stock-2" required=""></div>*/}
                        {/*<div   value="+"  onClick = {this.addStock} className="button_add_stock w-button"></div>*/}


                        <input  type="text" className="text_field_stock w-input" maxLength="256" name="Add-stock"
                                data-name="Add stock" placeholder="Add stock" id="Add-stock-2" required=""></input>
                            <input  onClick = {this.addStock} type="submit" value="+" data-wait="Please wait..."
                                    className="button_add_stock w-button"></input>
                        <input  onClick = {this.addNegStock} type="submit" value="-" data-wait="Please wait..."
                                className="button_add_stock w-button"></input>
